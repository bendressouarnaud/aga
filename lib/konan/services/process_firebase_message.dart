        ...
        if(message.data['type'] == "ART") {
          ...
          if(apprenti != null) {
            Apprenti updateApprenti = Apprenti(
                ...
                statutLivraison: apprenti.statutLivraison,
                confirmationLivraison: apprenti.confirmationLivraison,
                photoSignatureLivraison: apprenti.photoSignatureLivraison
            );
          ...
          if(compagnon != null) {
            Compagnon updateCompagnon = Compagnon(
                ...
                confirmationLivraison: compagnon.confirmationLivraison,
                photoSignatureLivraison: compagnon.photoSignatureLivraison,
              statutLivraison: compagnon.statutLivraison
            );
          ...
          Entreprise updateEntreprise = Entreprise(
            ...
            statutLivraison: entreprise.statutLivraison,
            confirmationLivraison: entreprise.confirmationLivraison,
            photoSignatureLivraison: entreprise.photoSignatureLivraison
          );
