...
class _InterfaceApprentiPersonne extends State<InterfaceApprentiPersonne> {
  ...
  TextEditingController dateDebutApprentissageController = TextEditingController();
  ...
  final DateDebutActiviteGetController _dateDebutApprentissageController = Get.put(DateDebutActiviteGetController());
  ...
  void feedApprenti() async{
    ...
    final result = await Navigator.push(context,
      ...
      return const InterfacePriseApprentiPhoto();
    }));
  ...
  Future<void> _selectDateDebutApprentissage() async {
    choixDate = 1;
    ...
    if (selectedDate == null) return;
    _dateDebutApprentissageController.addData(selectedDate);
  }
    ...
    return [
      ...
      Container(
          ...
          child: DropdownMenu<GenericData>(
              ...
              enableSearch: false,
              enableFilter: false,
              label: const Text('Avez-vous appris le métier ?'),
              // Initial Value
              onSelected: (GenericData? value) {
                setState(() {
                  // Set value to 0
                  if(value!.id == 0){
                    laFinFormation = lesGenericData.where((l) => l.id == 0).first;
                  }
      ...
      Visibility(
          visible: lApprentissageMetier.id == 1,
          child: Container(
              width: MediaQuery.of(context).size.width,
              ...
              child: Row(
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: TextField(
                      keyboardType: TextInputType.text,
                      controller: intituleFormationController,
                      decoration: const InputDecoration(
                        border: OutlineInputBorder(),
                        labelText: 'Intitulé formation',
                      ),
                      style: const TextStyle(
                          height: 1.5
                      ),
      ...
      Visibility(
          ...
          child: Container(
            ...
            child: DropdownMenu<GenericData>(
                width: MediaQuery.of(context).size.width,
                menuHeight: 250,
                initialSelection: laFinFormation,
                controller: finFormationController,
                hintText: "Avez vous terminé la formation ?",
                requestFocusOnTap: false,
                enableSearch: false,
                enableFilter: false,
                label: const Text('Avez vous terminé la formation ?'),
                // Initial Value
                onSelected: (GenericData? value) {
                  setState(() {
                    laFinFormation = value!;
                  });
                },
                dropdownMenuEntries:
                lesGenericData.map<DropdownMenuEntry<GenericData>>((GenericData menu) {
      ...
      Visibility(
          ...
          child: Container(
            ...
            child: TextField(
              keyboardType: TextInputType.text,
              controller: diplomeObtenuController,
              decoration: const InputDecoration(
                border: OutlineInputBorder(),
                labelText: 'Diplôme obtenu',
              ),
              style: const TextStyle(
                  height: 1.5
              ),
            ...
            children: [
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: const Text("Date début Apprenti",
                      style: TextStyle(
                          color: Colors.white
                      )
                  ),
                  onPressed: () {
                    _selectDateDebutApprentissage();
                  },
                  icon: const Icon(
                    Icons.access_time_outlined,
                    size: 20,
