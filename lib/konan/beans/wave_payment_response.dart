class WavePaymentResponse {
  ...
  const WavePaymentResponse({
    required this.id, required this.amount, required this.checkout_status, required this.client_reference,
    required this.currency, required this.error_url, required this.last_payment_error, required this.business_name,
    required this.payment_status, required this.success_url, required this.wave_launch_url,
    required this.when_completed, required this.when_created, required this.when_expires
  });
